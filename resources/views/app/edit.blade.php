                            ...
                            <form action="" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="control-group col-12">
                                        ...
                                        <input type="text" class="form-control" name="email" id="email" value="{{$etudiant->email}}">
                                    </div>
                                    <div class="control-group col-12">
                                        <!-- Date de naissance -->
                                        <label for="dateNaissance">Date de naissance</label>
                                        <input type="text" class="form-control" name="dateNaissance" id="dateNaissance" value="{{$etudiant->dateNaissance}}">
                                    </div>
                                    <div class="control-group col-12">
                                        <!-- Ville -->
